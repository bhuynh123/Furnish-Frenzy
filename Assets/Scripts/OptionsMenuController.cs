using UnityEngine;
// Removed duplicate using UnityEngine;
...
public class OptionsMenuController : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        // Wire up buttons explicitly using UnityEngine.UIElements.Button
        root.Q<UnityEngine.UIElements.Button>("applyButton").clicked += ApplySettings;
        root.Q<UnityEngine.UIElements.Button>("resetButton").clicked += ResetSettings;
    }
